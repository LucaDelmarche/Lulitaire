...
public class ItemPatchUsernameHandler: IEmptyOutputCommandHandler<ZonePatchCommand>
{
    private readonly IGenericRepository<DbZone> _repository;
    private readonly IMapper _iMapper;

    public ItemPatchUsernameHandler(IGenericRepository<DbZone> repository, IMapper iMapper)
    {
